...
RDEPEND="
	...
	>=www-client/epiphany-3.36.1
	>=app-arch/file-roller-3.36.2
	>=gnome-extra/gnome-calculator-3.36.0
	>=gnome-extra/gnome-calendar-3.36.1
	>=gnome-extra/gnome-characters-3.32.1
	>=sys-apps/gnome-disk-utility-3.36.1
	...
	tracker? (
		...
		>=media-sound/gnome-music-3.36.2 )
"
DEPEND=""
BDEPEND=""
S=${WORKDIR}
