...
DEPEND="
	...
	systemd? ( >=sys-apps/systemd-31
		>=gnome-base/gnome-desktop-3.35.90:3=[systemd] )
	...
	>=dev-libs/atk-2.34[introspection]
	dev-libs/libical:=
...
RDEPEND="${DEPEND}
	...
	>=app-accessibility/at-spi2-core-2.34:2[introspection]
...
PATCHES=(
	...
	"${FILESDIR}"/3.36-optional-bluetooth.patch
	# Change favorites defaults, bug #479918
	"${FILESDIR}"/3.36.0-defaults.patch
)
