...
DEPEND="
	...
	>=gnome-base/gsettings-desktop-schemas-3.35.91[introspection?]
	...
	screencast? ( >=media-video/pipewire-0.3:0/0.3 )
...
PATCHES=(
	...
	"${FILESDIR}"/mutter-3.36.1-fix-build-without-libwacom.patch
)
